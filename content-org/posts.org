...
** DONE Migrating Blog from Wordpress to Org Mode
*** DONE Migrating my Blog from Wordpress to Org Mode
:PROPERTIES:
...
*** DONE 𐑥𐑲𐑜𐑮𐑱𐑑𐑦𐑙 𐑥𐑲 𐑚𐑤𐑪𐑜 𐑓𐑮𐑪𐑥 ·𐑢𐑻𐑛𐑐𐑮𐑧𐑕 𐑑 ·𐑹𐑜 𐑥𐑴𐑛
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: 20241226_org-mode-blog
...
** DONE Updates to Gallium Keyboard Layout
:PROPERTIES:
:EXPORT_FILE_NAME: index
...
[[file:Screenshot_2024-10-10_18-16-04-1024x234.png]]
...
** DONE Gallium Keyboard Layout :Computers:Keyboards:
:PROPERTIES:
...
[[file:20241002-gallium-1536x678.png]]
...
[[file:Screenshot_2024-10-02_17-33-57-1024x589.png]]
...
*** TODO 𐑯𐑿 ·𐑗𐑪𐑒 𐑕𐑢𐑦𐑗𐑩𐑟 𐑣𐑨𐑝 𐑼𐑲𐑝𐑛! :Computers:Keyboards:
:PROPERTIES:
:CUSTOM_ID: new-choc-switches-have-arrived.en_Shaw
:EXPORT_HUGO_BUNDLE: 20240914_new-choc-switches-have-arrived
:EXPORT_FILE_NAME: index.en-Shaw.md
:EXPORT_DATE: 2024-09-14
:EXPORT_HUGO_MENU:
...
** DONE Home Row Layer Keys :Computers:Keyboards:
:PROPERTIES:
...
** DONE ISRT Keyboard Layout :keyboards:corne:
:PROPERTIES:
...
[[file:20240803-isrt-anglemod.en_.ansi_-1024x312.jpg]]
...
[[file:20240721-corne_v4_mini-1024x365.jpg]]
...
[[file:20240721-connector-1024x751.jpg]]
...
** DONE 34 Key Layout for Corne Keyboard :keyboards:corne:
:PROPERTIES:
...
I’ve been experimenting a bit more with the Corne keyboard. I saw a [[https://youtu.be/8wZ8FRwOzhU?si=Y1a1JSbGsN1vZizU][video from Ben Vallack]] where he lays out a mapping for his 34-key keyboard.
...
** DONE Corne v4 Keyboard Keymap :keyboards:corne:
:PROPERTIES:
:EXPORT_FILE_NAME: index
...
#+ATTR_HTML: :title My new Corne keyboard
[[file:20240711-corne_6x3.jpg]]
#+hugo: more
...
[[file:20220130-IMG_4547_01-999x1024.jpg]]

On the Australian TV Series Doctor Doctor, there’s a recurring piece of music that is playing using fingerpicking on the ukulele based on Bonnie Tyler’s hit song It’s a Heartache. A quick search on YouTube discovered that it comes from the lead-in of a [[https://youtu.be/GqynAAYdLW8][music video by the Wellington International Ukulele Orchestra]].

I was keen to learn how to play something like it on my own ukulele, and a further search turned up a [[https://youtu.be/pCswBsuddrc][tutorial by Helmut Bickel]], where he has some hand-written tablature in the background of the video. To have the tab in a more convenient format, I wrote it up using the [[http://lilypond.org/][lilypond]] music typesetting software, and the resulting PDF is [[file:20220130-heartache-tab.pdf][reproduced here]].
...
[[file:20220202-Screen-Shot-2022-02-02-at-6.32.54-pm.png]]
...
[[file:20200120-Screenshot_2022-02-02_21-07-23-1024x550.png]]
...
A recording of the talk will be available on the [[https://www.youtube.com/user/VK2MB][MWRS YouTube channel]] in due course. The presentation slides I used may be found [[file:20220120-photography_for_hams.pdf][here]].
...
[[file:20191004-961C3B92-E725-4065-9A38-54BE23EDC24B.jpeg]]
...
[[file:20191003-37FE80D9-053E-4D88-B858-B13645808C57.png]]
...
[[file:20141420-IMG_0118-Version-2-768x1024-1.jpg]]
...
The [[https://youtu.be/xnVgbdkK_Iw][lecture was recorded]] and can be found on the club’s YouTube channel. The [[https://www.slideshare.net/VK2MB/april-2014-lecture-beverage-antennas][slidepack]] is available on slideshare.
