...
*** DONE Graphite Layout on Corne Keyboard :Computers:Keyboards:Corne:AltKeyboardLayouts:Gallium:Graphite:MechKeyboard:SplitKeyboard:
:PROPERTIES:
...
*** DONE Updates to Gallium Keyboard Layout :Computers:Keyboards:AltKeyboardLayouts:MechKeyboard:SplitKeyboard:Gallium:Graphite:ISRT:
:PROPERTIES:
...
** Home Row Layer Keys
*** DONE Home Row Layer Keys :Computers:Keyboards:AltKeyboardLayouts:MechKeyboard:SplitKeyboard:ISRT:Miryoku:
:PROPERTIES:
...
** ISRT Keyboard Layout
*** DONE ISRT Keyboard Layout :Computers:Keyboards:Corne:AltKeyboardLayouts:MechKeyboard:SplitKeyboard:Colemak:ISRT:
:PROPERTIES:
...
** Corne V4.1 Mini
*** DONE Corne V4.1 Mini :Keyboards:Corne:Miryoku:Colemak:MechKeyboard:SplitKeyboard:AltKeyboardLayouts:
:PROPERTIES:
...
*** DONE 34 Key Layout for Corne Keyboard :Computers:Keyboards:Corne:AltKeyboardLayouts:Colemak:MechKeyboard:SplitKeyboard:
:PROPERTIES:
