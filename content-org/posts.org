...
** TODO Hosting a Valheim Plus server on a VPS with Podman and docker-compose :linux:containers:selfhosting:
...
** TODO To our own detriment :rant:foss:mastodon:
...
** TODO Enshittification protests beget more enshittification :rant:foss:
...
** TODO In appreciation of podcasts :rant:
...
** TODO Starting a webring in 2024 :foss:
...
** TODO 2024 Total Eclipse Prep :fun:
...
** TODO Joy is free and comes in small packages :fun:
...
#+hugo: more
** TODO When open source goes source available :foss:rant:
...
** TODO Alacritty Auto Theme Switcher :linux:foss:alacritty:
...
** TODO Firefox scrollbar size :foss:firefox:
...
** TODO filmPoster with Gum Hugo photo post bliss? :hugo:foss:
...
** TODO Alacritty: TOML and partial imports :linux:foss:alacritty:
...
** TODO URL shortening for blog links natively in Hugo :foss:hugo:emacs:
...
#+end_export
** TODO Tech debt for personal projects :foss:rant:
...
** TODO Eagles in the "backyard" :camera:
...
** TODO Trigger site rebuild to update copyright
...
** TODO Let's Encrypt with acme.sh behind CPanel :linux:foss:
...
** TODO FOSS Woodworking :foss:woodworking:
...
** TODO Fiddly Fig :art:watercolor:
...
** TODO Markdown anchor linking on Github :emacs:foss:
...
** TODO From fish on Gnome Terminal to zsh with Starship on Alacritty :foss:linux:alacritty:
...
** TODO QMK caps word :foss:keyboard:
...
** TODO Hugo photos with EXIF data :foss:hugo:
...
** TODO OBS, virtual camera, guix :foss:guix:linux:
...
** TODO Found Nemo! :art:watercolor:
...
** TODO Water color paint key/legend :art:watercolor:
...
** TODO Setting up Protonmail in Emacs :emacs:linux:
...
** TODO "Inverse literate" config via org-transclusion :emacs:
...
** TODO Doom Emacs config (deprecated) :emacs:
...
** TODO Highland Chewie :art:watercolor:
...
** TODO Emacs which-key prefix labels :emacs:
...
** TODO Emacs custom configuration :emacs:
...
** TODO Sony A7c initial customization :camera:
...
** TODO org-bars view for outlining/folding :emacs:
...
** TODO Wine and CrossOver to use Lightroom on Linux :foss:linux:
...
** TODO Fully automated deployment :emacs:foss:
