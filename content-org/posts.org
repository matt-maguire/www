...
** A Study in Scarlet
*** DONE A Study in Scarlet :Shavian:
:PROPERTIES:
:EXPORT_FILE_NAME: index.md
...
*** DONE Migrating my Blog from Wordpress to Org Mode :Emacs:OrgMode:Esperanto:Shavian:
:PROPERTIES:
:EXPORT_FILE_NAME: index
...
*** DONE Migrating Blog from Wordpress to Org Mode :Emacs:OrgMode:Esperanto:Shavian:
:PROPERTIES:
