...
date = 2024-12-29
lastmod = 2024-12-29T18:58:38+11:00
...
I followed the instructions in the article and soon had a customised build of my Oryx layout with the required key overrides enabled and configured. I flashed the new firmware to my Voyager, and it sprung back to life... until I pressed a key, that is. The keyboard froze! The firmware would initiase, but it would crash as soon as I tried to type something. I experimented, thinking I may have messed up the key override code, but it would crash even when I didn't make any changes to the base Oryx code. Clearly there was an issue with the build scripts supplied by the author of the article, but I didn't have time to try to debug it and decided to stick with the Gallium layout that was already serving me quite well.
